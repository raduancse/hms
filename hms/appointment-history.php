                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['appointmentDate']; ?> / <?php
                                                        echo
                                                        $row['appointmentTime'];
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td >
                                                        <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                            <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) {
                                                                ...
                                                                <a href="info_user.php?id=<?php echo $row['id'] ?>" class="btn btn-transparent btn-xs tooltips" title="info Appointment" tooltip-placement="top" tooltip="">Info</a>
                                                                <?php
                                                            } else {
