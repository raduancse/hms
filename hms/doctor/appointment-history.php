                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?>
                                                    ...
                                                    <a href="info_user.php?id=<?php echo $row['userId']?>&rowId=<?php echo $row['id']?>" class="btn btn-transparent btn-xs tooltips" title="info Appointment" tooltip-placement="top" tooltip="">Info</a>
