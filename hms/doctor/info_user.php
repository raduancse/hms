...
$ret=mysqli_query($con,"SELECT * FROM appointment WHERE id='". $_GET['rowId'] . "'");
            ...
            <div class="">
                <div class="">
                    <div class='list-group gallery'>
                        ...
                        <?php
                        $ret=mysqli_query($con,"SELECT * FROM user_info WHERE userId='". $_GET['id'] . "'");
                ...
                <form action="upload.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="hidden" name="appointment" value="<?php echo $_GET['rowId']?>">
